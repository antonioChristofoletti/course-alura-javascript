...
var MensagemView = exports.MensagemView = function (_View) {
    ...
    function MensagemView() {
        ...
        return _possibleConstructorReturn(this, (MensagemView.__proto__ || Object.getPrototypeOf(MensagemView)).call(this, document.querySelector("#mensagemView")));
    }

    _createClass(MensagemView, [{
        key: "model",
        value: function model(mensagem) {
            return "<p>" + mensagem.texto + "</p>";
        }
    }, {
        key: "update",
        value: function update(mensagem) {
            if (mensagem.texto === "") {
